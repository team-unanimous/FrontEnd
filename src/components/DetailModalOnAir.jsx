...
const DetailModalOnAir = ({open, close,meetingTitle,meetingDate,meetingTime,meetingCreator,issues, meetingId,meetingThumbnail}) => {
...
export default DetailModalOnAir